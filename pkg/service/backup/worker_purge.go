...
func (w *worker) Purge(ctx context.Context, hosts []hostInfo, manifestParallelism int, retentionMap RetentionMap) (err error) {
	...
	err = hostsInParallel(hosts, manifestParallelism, func(h hostInfo) error {
